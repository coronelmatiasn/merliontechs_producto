...
import test.ProdTestAppBonusApp;
import test.domain.ProductBucket;
import test.repository.ProductBucketRepository;
 ...
 */
@SpringBootTest(classes = ProdTestAppBonusApp.class)
