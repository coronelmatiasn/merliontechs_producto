...
export const ProductDeleteDialog = (props: IProductDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="prodTestAppBonusApp.product.delete.question">
        <Translate contentKey="prodTestAppBonusApp.product.delete.question" interpolate={{ id: productEntity.id }}>
