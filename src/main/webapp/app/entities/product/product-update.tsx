  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="prodTestAppBonusApp.product.home.createOrEditLabel">
            <Translate contentKey="prodTestAppBonusApp.product.home.createOrEditLabel">Create or edit a Product</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
