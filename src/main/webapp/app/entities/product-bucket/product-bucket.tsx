  ...
  return (
    <div>
      <h2 id="product-bucket-heading">
        <Translate contentKey="prodTestAppBonusApp.productBucket.home.title">Product Buckets</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="prodTestAppBonusApp.productBucket.home.createLabel">Create new Product Bucket</Translate>
        </Link>
      </h2>
        ...
        {productBucketList && productBucketList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="prodTestAppBonusApp.productBucket.availableToSellQuantity">Available To Sell Quantity</Translate>
                </th>
                <th>
                  <Translate contentKey="prodTestAppBonusApp.productBucket.inChargeQuantity">In Charge Quantity</Translate>
                </th>
                <th>
                  <Translate contentKey="prodTestAppBonusApp.productBucket.brokenQuantity">Broken Quantity</Translate>
                </th>
                <th>
                  <Translate contentKey="prodTestAppBonusApp.productBucket.product">Product</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="prodTestAppBonusApp.productBucket.home.notFound">No Product Buckets found</Translate>
            </div>
          )
        )}
      </div>
