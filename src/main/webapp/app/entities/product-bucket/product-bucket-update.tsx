  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="prodTestAppBonusApp.productBucket.home.createOrEditLabel">
            <Translate contentKey="prodTestAppBonusApp.productBucket.home.createOrEditLabel">Create or edit a ProductBucket</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
